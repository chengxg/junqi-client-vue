...
Room.prototype.initStatus = function(roomStatus) {
	...
	if(roomStatus["p1s"]) {
		...
		this.player1.socket = this.mediator.sockets.socketClient1;
	}
	if(roomStatus["p2s"]) {
		this.player2 = this.createPlayer(roomStatus["p2s"].n, roomStatus["p2s"], null);
		this.player2.socket = this.mediator.sockets.socketClient2;
	}
};
/**
 * 初始化房间状态的字段
...
Room.prototype.initTestChessboard = function() {
	...
	this.chessboard[7] = [101];
	this.chessboard[8] = [102];
	this.chessboard[9] = [109];
	this.chessboard[10] = [222];
	this.chessboard[11] = [500];
	this.chessboard[12] = [201];
	this.chessboard[13] = [202];
	this.chessboard[14] = [203];
	this.chessboard[15] = [204];
	this.chessboard[16] = [205];
	this.chessboard[17] = [500];
};
